...
if ALLOWED_HOSTS_ENV:
    ...
    ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'janhelp-mnrqcf3h.b4a.run', '.b4a.run', '*']
...
# Media Storage
# DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStorage' - Handled in STORAGES
MEDIA_URL = "/media/"
