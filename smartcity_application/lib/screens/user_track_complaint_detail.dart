...
class _UserTrackComplaintDetailState extends State<UserTrackComplaintDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: complaint.isEmpty 
        ...
        : CustomScrollView(
            slivers: [
              _buildAppBar(complaint),
              SliverToBoxAdapter(
                child: Column(
                  children: [
                    // Interactive Map Section
                    _buildInteractiveMapSection(complaint),
  ...
  Widget _buildAppBar(Map<String, dynamic> complaint) {
    return SliverAppBar(
      expandedHeight: 120,
      floating: false,
      pinned: true,
      ...
      flexibleSpace: FlexibleSpaceBar(
        title: Text(
          '#${complaint['complaint_number'] ?? 'Unknown'}',
        ...
        background: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Color(0xFF2B6CF6), Color(0xFF1E40AF)],
            ),
          ),
          child: SafeArea(
            child: Padding(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          complaint['title']?.isNotEmpty == true ? complaint['title'] : '-',
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 16,
      ...
      actions: [
        IconButton(
          ...
          onPressed: () => _shareComplaint(complaint),
        ),
      ],
    );
  }
